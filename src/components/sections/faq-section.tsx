...
export default function FAQSection() {
  return (
    <div className="mt-40 overflow-hidden bg-[#d5c1ad]/30 py-40">
      <MainContainer
        id="faq"
        as="section"
      ...
      >
        ...
        <Paragraph className="max-w-[500px] text-center">
          Aquí encontrarás respuestas a las dudas más comunes sobre mis
          servicios. Si tienes más preguntas, no dudes en escribirme.
        </Paragraph>
